...
import web from "../src/images/swastika_logo.webp";
                ...
                <div className="row">
                    <div className="col-10 mx-auto">
                        <nav className="navbar navbar-expand-lg bg-body-tertiary">
                            <div className="container-fluid">
                                <NavLink activeclassname="menu_active" className="navbar-brand" href="#">
                                    <img src={web} className="img" alt="home img"/></NavLink>
